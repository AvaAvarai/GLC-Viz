...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/DDUx3ibLT2)
...
```sh
npx nx serve GLC-Viz
```

To create a production bundle:

```sh
npx nx build GLC-Viz
```

To see all available targets to run for a project, run:

```sh
npx nx show project GLC-Viz
```
